...
I wrote this article for managers of small teams/startups. I'd assume that most might not apply to management in larger enterprises.

This article is "my opinion" and is based on my experience.
...
* You either created processes where this outcome happened in
...
* Processes are not complex chains of people doing things burdened by overheads
    * *Processes are expectations made explicit*
        * They can be as simple as "every morning we all do X to ensure everyone else is unblocked."

#### Decisions vs Opinions

* In every discussion, it needs to be clear who makes decisions, everyone else only adds opinions.
    * Ideally, the person who will afterward do the follow-up work makes the decisions.
...
* Also, it's easy to trust when things go well
    ...
    * Always differ between your frustration about a situation and your frustration about a peson
...
* The easiest way to have people trust your work is by transparently sharing it without request.
    ...
    * Don't make them ask for it
        * Most won't – especially new people won't
...
*  Think of trust as something that you systemize
    * Eg what kind of trust do you give a new team member?
        * What are they expected to do in the first weeks?
...
#### Feedbacking people: people x context = output
...
* People should never be surprised that they are fired
    * New requirements on them in changed context should have been communicated
...
* Frequently people keep employees around in a zombie-like state
    ...
    * But you don't
        ...
        * You are most likely doing it for you
...
* Clear moments for essential decisions
...
* When looking for best practices or changes in the team, always look at first what already naturally emerged
...
* Fast-growing startups have to refactor how they operate every 6 months
    * As you grow you need to refactor anyhow in 3-6months 
...
* They should also, whenever possible, give spotlights to their team instead of taking it for themselves
    * The deal is simple: They get more authority, the team more ways to shine


I hope this helps 🙏

Feel free to send me questions via [twitter](https://twitter.com/andreasklinger) and if you like the article, [please share it](https://twitter.com/intent/tweet?text=Managing+People+an+article+by+@andreasklinger+)

If you have ideas on improving this article, please [send me pull-requests](https://github.com/andreasklinger/klinger-io)!
