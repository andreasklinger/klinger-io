...
# Here a few mental models that might you help thinking about your fundraising round differently
...
As long as you can argue why this number or effort is meaningful to your business and investors agree with you, you can use it to show your traction. It doesn’t always have to be revenue.
...
Most investors want to follow, not lead. Which is horrible for you as a founder as you end up with a lot of people who “would love to” hear from you once you have a lead. Basically “if you train is leaving the station, give me a call… i want to see if sequoia is on board”
...
Having people commit shows momentum. And if meanwhile, you realize that you might have escape-velocity and larger funds are interested you can increase the valuation of the next SAFEs or start a larger round. If the timing is close enough you can even mention the previous SAFEs as part of your funding round size.
...
“We are waiting for a lead to define the valuation” just means that nobody gave you ballpark numbers yet (most likely because you arent interesting enough) and that nobody can commit if they are 100% on it.

If you aren’t sure about your valuation yet, you should still be able to say something.

Communicate it like Harry Hurst [recommends here](https://twitter.com/harryhurst/status/1400252592479932416). Look at [AngelList’s numbers](https://stack.angellist.com/valuations), but consider the lowest 25th percentile (those stats suffer from strong survivorship bias).

**2) Introductions**

Also have a list of people you would love to have introductions to. This allows each person you talk to become a multiplier and increases your momentum

## Finding and closing your first angel investors
...
And even with one most likely you lack the proof-points and momentum yet for them to commit. So you will have a lot of calls with people who want to see if your “train might leave the station” but don’t want to jump on it.
...
Ask them to give you feedback about your actual challenges! Establish a relationship, ask them for further introductions to the people on your list.
...
We had great discussions with VCs, regular checkups, even serious partner meetings. We got so much feedback and homework to keep us busy. At the end of it we had a business plan (those were still a thing back then) in two languages, dozens of versions of our pitchdeck and a finance model that could even do balancing. But none of that helped us to close the round. That only happened much later and with the help of [Seedcamp](https://seedcamp.com/).
...
The biggest mistake we did in my first startup was to focus most of the founders on fundraising. We should have just kept most of the founding team heads down and keep building.
...
Build, get customer feedback, learn, move fast. Be “not fundraising but…” and gain momentum. Hopefully some of the tactics above will help you raising the money you need.
