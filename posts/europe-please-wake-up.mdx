...
Edit: this post was originally connected to eu/acc, which i helped co-initiate – i removed that affiliation as the community of eu/acc split and i don't agree with the political takes of several of the splitter groups.
