...
Passing a regulation via TFEU [Article 352](https://eur-lex.europa.eu/EN/legal-content/glossary/subsidiary-powers.html) is the true solution on European level that's needed. And if unamity votes sound scary to you, know that there is a potential path of "[enhanced cooperation](https://en.wikipedia.org/wiki/Enhanced_cooperation)" for those that agreed, afterwards.
...
**What we need**: EU–INC as defined in the [proposal](https://proposal.eu-inc.org/) – built with Europe's best startup legal teams, founders, investors and 100+ open-source contributors. A pan-European legal entity via Article 352, a unified digital registry, open to all companies. No tax or employment law bundled in, because that's the compromise that can actually pass.
